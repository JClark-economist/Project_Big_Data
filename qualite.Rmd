...
Globalement, on peut comparer les performances de deux modèles en comparant les aires sous leurs courbes ROC respectives. Par exemple le modèle ayant une courbe ROC qui coïncide avec la diagonale aura un aire sous la courbe de 0.5, ce qui correspond au score d'un modèle aléatoire. Le modèle parfait aura une aire sous la courbe de 1 et un modèle qui aurait une courbe ROC en dessous de la diagonale aurait une aire sous la courbe inférieure à 0.5, ce qui veut dire que ce modèle réaliserait des prédictions encore pires que des prédictions aléatoires. 
