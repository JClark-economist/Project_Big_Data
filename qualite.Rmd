...
Dans une **technique de classement**, on cherche à ce que le taux d'erreur, autrement dit la proportion d'individus mal classés, soit le plus bas possible. Plusieurs indicateurs de qualité sont à notre disposition tels que **la courbe ROC** et **l'indice de Gini**, que nous aurons l'occasion d'explorer par la suite.
...
Il faudra donc réaliser un arbitrage pour déterminer la taille optimale d'échantillon d'appprentissage à choisir.
...
Le sur-apprentissage n'est pas forcément uniquement dû à une trop grande complexité du modèle. Il peut être lié à un bon ajustement sur un échantillon biaisé, ou bien au fait qu'un variable explicative soit fortement corrélé avec la variable à expliquer.

### Phase d'apprentissage



### Phase de test, courbe ROC et indice de Gini
