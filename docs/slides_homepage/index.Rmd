...
## Vous êtes probablement familiés avec la régression linéaire.
...
Imaginons que nous voulions expliquer le poids de d'un individu $i$ en fonction de certaines de ses caractéristiques. Par exemple :
...
Tout de suite, un modèle de regression linéaire semble moins adapté. Pourquoi ?
...
### Des exemples d'utilisation des modèles de classification
...
2. Un service bancaire en ligne doit être capable de déterminer si une transaction est réalisée sur sur son site est frauduleuse ou non, en ne connaissant que l'adresse IP et l'historique de l'utilisateur.
